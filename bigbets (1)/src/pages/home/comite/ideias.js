...
import updateIdeia from '../../../servicesAPI/updateOportunity'
import deleteIdeia from '../../../servicesAPI/deleteIdeia'
...
<>
       <div class="list-group-item list-group-item-action flex-column align-items-start btn-outline-primary">
              ...
              <small>{ideia.id}</small>
               ...
               <button className="btn btn-success btn-sm" onClick={(event) => this.handleAprove(ideia._id)}>Aprovar</button>

                <button className="btn btn-danger btn-sm" onClick={(event) => this.handleDecline(ideia._id)}>Recusar</button>
              </div>
